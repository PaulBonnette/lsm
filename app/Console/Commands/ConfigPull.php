...
class ConfigPull extends Command implements PromptsForMissingInput
{
    /**
     ...
     * @var string
     */
    protected $signature = 'lsm:config-pull {server}';
    ...
    public function handle()
    {
        ...
        Process::Command("rsync -a --exclude='servers' --exclude='.env' --exclude='.git*' \"$user@$domain:~/$PROJECT_DIRECTORY/servers/$domain_alias/\" \"./servers/$domain_alias/\" "))
